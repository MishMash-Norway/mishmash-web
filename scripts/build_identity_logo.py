...
Reads  themes/identity/assets/images/logo/mishmash-wordmark-black.svg
Writes themes/identity/assets/images/logo/*, themes/identity/_includes/mm-wordmark.svg
       and themes/identity/assets/css/wordmark-animation.css.
Needs inkscape and ImageMagick (convert) on PATH. Only run it if the wordmark changes."""
import re, subprocess, os
import pathlib
ROOT = str(pathlib.Path(__file__).resolve().parent.parent)
OUT = f"{ROOT}/themes/identity/assets/images/logo"
INC = f"{ROOT}/themes/identity/_includes"
...
# 2. Inline include: no <style>, fill from currentColor, keyframes live in theme.css.
...
open(f"{ROOT}/themes/identity/assets/css/wordmark-animation.css", "w").write(
    "/* Generated by scripts (see themes/identity/README.md): keyframes for the inline wordmark. */\n"
    + css("1", ".mm-wordmark.is-rolling ") + "\n")
