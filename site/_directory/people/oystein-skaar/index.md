...
search_keywords: []
selected_works:
- title: 'The Gentler Researcher: Examining Research Bias and Gender Stereotypes in
    Sikt AI Chat'
  year: '2026'
...
- title: Skroting av lærernormen – basert på forskning?
  ...
  - name: Odin Thune Brønstad
  - name: Sigrun Sønsthagen
  - name: Alona Laski
  - name: Kristin Kathinka Due Bergseth
  - name: Elisabeth Suzen
  - name: Gøril Brataas
  - name: Wenche Fjeld
  - name: Trine Kampmann-Jensen
  - name: Jonas Yassin Iversen
  - name: Tanvi Sirari
  - name: Thomas Caplin
  - name: Svein-Erling Greiner
  - name: Ana Lucia Lennert Da Silva
  - name: Ann-Therese Dalbakk Nomerstad
  - name: Anja Maria Pesch
  - name: Jens Haugan
  - name: Aud Marie Aamodt-Brænden
  - name: Marit Elise Lyngstad
  - name: Solvor Kristin Borren
  - name: Gry Sagmo Aglen
  - name: Odd Rune Stalheim
  - name: Ole Kolbjørn Kjørven
  - name: Minttu Minna Sirena Johler
  - name: Ida Jahr
    slug: ida-jahr
    url: /people/ida-jahr/
  - name: Pauline Book
  - name: Jane Haugseth
  - name: Catharine Meissner
  - name: Gaute Rydland Nilsen
  - name: Eirin Haug Bordal
  - name: Synnøve Markeng
  - name: Agnes Westgaard Bjelkerud
  - name: Oddmund Toft
  - name: Eirik Askerøi
  - name: Tove Lain Knudsen
  - name: Hanne Høglind
  - name: Ingeborg Amundrud
  - name: Anne Grethe Kjelling
  - name: Steffen Egge Frøyhov
  - name: Marianne Eek
  - name: Tonje Skoglund
  - name: Harald Bergh
  - name: Susan Lee Nacey
  - name: Svenn-Arve Myklebost
  - name: Hege Merete Somby
  - name: Stian Vestby
  - name: Johannes Lunde Hatfield
  - name: Inger-Kristin Larsen Vie
  - name: Øystein Olav Skaar
    slug: oystein-skaar
    url: /people/oystein-skaar/
- title: Støtte til lærerne fra lærerutdannere ved Universitetet i Innlandet
  ...
  - name: Tonje Haslie Bråten
  - name: Sidsel Undseth Bakke
  - name: Øystein Olav Skaar
    slug: oystein-skaar
    url: /people/oystein-skaar/
  - name: Andreas Seland
  ...
  - name: Catharine Meissner
  - name: Dorthe Gunnhildsdatter Hagen
  - name: Thomas Caplin
  - name: Sturla Ledsaak Nordlund
  - name: Eirin Haug Bordal
  - name: Jon Anders Græsli
  - name: Ann-Therese Dalbakk Nomerstad
  - name: Svein Harald Bigum
  - name: Anne-Brit Soma Reienes
  - name: Juliane Killerud Bekkevold
  - name: Solvor Kristin Borren
  - name: Eirik Askerøi
  - name: Helge Årsheim
  - name: Camilla Kvaal
  - name: Anna Gunnarsson Jota
  - name: Ingeborg Amundrud
  - name: Kai Arne Hansen
