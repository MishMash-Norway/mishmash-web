...
department: Department of Business, Strategy and Political Sciences
institution: ''
institutions:
...
urls:
  personal_website: ''
  institutional_website: https://www.kristiania.no/om-kristiania/ansatte/fakultet-for-ledelse-og-okonomi/institutt-for-markedsforing-og-okonomi/jonas-astrom/
  github: ''
  linkedin: https://www.linkedin.com/in/jonasaastroem/
  orcid: https://orcid.org/0000-0002-2088-0282
  nva: https://nva.sikt.no/research-profile/602969
  youtube: ''
  facebook: ''
  mastodon: ''
  instagram: ''
...
- title: International Case Studies in Visitor Attractions
  ...
  url: https://doi.org/10.4324/9781003479871
  contributors:
  - name: Gürhan Aktaş
    role: Editor
  - name: Carissa Baker
  ...
  - name: Wim Strijbosch
    role: Creator
  - name: Emre Samancıoğlu
    role: Creator
  - name: Emrah Özkul
    role: Creator
  - name: Selda Uca Karacabey
    role: Creator
  - name: Jonas Karlsen Åstrøm
    role: Creator
    slug: jonas-karlsen-astrm
    url: /people/jonas-karlsen-astrm/
  - name: Amanda Jo Templeton
    role: Creator
  - name: Ayşegül Gündüz Songur
    role: Creator
  - name: Juliana Rodrigues Vieira Tkatch
    role: Creator
  - name: Karen C. N. Tavares
    role: Creator
  - name: Martyn Pring
    role: Creator
  - name: Serim Paker
    role: Creator
  - name: Aşkın Özdağoğlu
    role: Creator
  - name: José Luis Aguirre-Valencia
    role: Creator
  - name: Sergio Alvarez
    role: Creator
  - name: Özgür Devrim Yılmaz
    role: Creator
  - name: Manolya Aksatan Kaplanseren
    role: Creator
  - name: Veronica Gregory
    role: Creator
  - name: Yareth Habermehl
    role: Creator
  - name: Brian Collins
    role: Creator
  - name: Aaron Tkaczynski
    role: Creator
  - name: Sharyn Rundle-Thiele
    role: Creator
  - name: Esti Venske
    role: Creator
  - name: Parveen Ebrahim
    role: Creator
  - name: Brendon Knott
    role: Creator
  - name: Emily Beeland
  ...
  - name: Carissa Baker
    role: Creator
- title: 'Case six: Selling SNØ to snowbirds'
  year: '2026'
  source: Non-fiction chapter
  group_type: Non-fiction chapter
  url: https://doi.org/10.4324/9781003479871-6
  contributors:
  - name: Jonas Karlsen Åstrøm
    role: Creator
    slug: jonas-karlsen-astrm
...
- title: Theming and Sustainability in Experiences
  ...
  url: https://doi.org/10.4324/9781003477839-14
  contributors:
  - name: Jonas Karlsen Åstrøm
    role: Creator
    slug: jonas-karlsen-astrm
...
- title: 'Kapittel 7: Fra flaggskip til forbruker: Betydningen av den fysiske butikken
  ...
  source: Book chapter
  group_type: Book chapter
  url: https://doi.org/10.23865/cdf.254.ch7
  contributors:
  - name: Jonas Karlsen Åstrøm
    role: Creator
    slug: jonas-karlsen-astrm
...
- title: 'Temaparker: Hvordan skapes egentlig Disneyland-effekten?'
  ...
  url: https://forskersonen.no/meninger-populaervitenskap-temaparker/temaparker-hvordan-skapes-egentlig-disneyland-effekten/2174221
  contributors:
  - name: Jonas Karlsen Åstrøm
    role: Creator
    slug: jonas-karlsen-astrm
