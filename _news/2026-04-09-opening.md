...
MishMash is organised into [seven work packages](https://mishmash.no/about/#how), each with a different thematic focus. The first task is to get to know one another better. All work packages have begun online meeting series, and several of them met for the first time in person during the event.
